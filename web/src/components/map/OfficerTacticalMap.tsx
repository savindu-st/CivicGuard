  ...
  return L.divIcon({
    ...
    html: `
      <div style="position: relative; width: 34px; height: 34px; display: flex; align-items: center; justify-content: center;">
        ...
        <div style="width: 26px; height: 26px; border-radius: 50%; background: ${bgColor}; border: 2px solid #ffffff; ${selectedRing} display: flex; align-items: center; justify-content: center; color: white; font-weight: 800; font-size: 13px; transition: all 0.2s;">
          ${symbol}
        </div>
      </div>
    `,
  ...
  return L.divIcon({
    ...
    html: `
      <div style="position: relative; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
        ...
        <div style="width: 22px; height: 22px; border-radius: 6px; background: ${color}; border: 2px solid #ffffff; box-shadow: 0 2px 6px rgba(0,0,0,0.2); display: flex; align-items: center; justify-content: center; color: white; font-size: 11px; font-weight: bold;">
          👷
        </div>
      </div>
    `,
    ...
    <div className="relative w-full h-full min-h-[500px] rounded-xl overflow-hidden border border-slate-200 shadow-sm bg-slate-50">
      ...
      <div className="absolute top-3 left-3 z-[400] bg-white/95 backdrop-blur-md px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs shadow-md space-y-1.5 pointer-events-auto">
        ...
        {dispatchVectors.length > 0 && (
          <div className="pt-1 border-t border-slate-200 text-[10px] text-blue-700 font-bold flex items-center gap-1">
                ...
                <Popup>
                  <div className="p-1 space-y-1.5 text-xs">
                    ...
                    <button
                      ...
                      className="w-full mt-2 py-1.5 px-2.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-bold text-[11px] transition-colors shadow-xs"
                    >
